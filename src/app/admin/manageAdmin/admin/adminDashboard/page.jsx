              ...
              >
                <div className="bg-black/60 to-white/5 p-6 rounded-lg">
                  <div className="flex flex-row space-x-4 items-center">
                    ...
                    <div>
                      <p className="text-indigo-300 text-md font-medium uppercase leading-4">
                        Users
                      </p>
                      <p className="text-white font-bold text-2xl inline-flex items-center space-x-4">
                        <span>+28</span>
                        <span>
                          <svg
                            xmlns="http://www.w3.org/2000/svg"
                ...
                <div className="bg-black/60 p-6 rounded-lg">
                  <div className="flex flex-row space-x-4 items-center">
                    ...
                    <div>
                      <p className="text-teal-300 text-md font-medium uppercase leading-4">
                        Income
                      </p>
                      <p className="text-white font-bold text-2xl inline-flex items-center space-x-4">
                        <span>$2,873.88</span>
                ...
                <div className="bg-black/60 p-6 rounded-lg">
                  <div className="flex flex-row space-x-4 items-center">
                    ...
                    <div>
                      <p className="text-blue-300 text-md font-medium uppercase leading-4">
                        Invoices
                      </p>
                      <p className="text-white font-bold text-2xl inline-flex items-center space-x-4">
                        <span>+79</span>
                ...
                <div className="bg-black/60 to-white/5 rounded-lg">
                  <div className="flex flex-row items-center">
                    ...
                    <div className="p-2">
                      ...
                      <p className="text-gray-500 text-md">24 Nov 2022</p>
                    </div>
                  </div>
                  <div className="border-t border-white/5 p-4">
                    <a
                      href="#"
                      className="inline-flex space-x-4 items-center text-center"
                    >
                      <svg
                        xmlns="http://www.w3.org/2000/svg"
                        fill="none"
                ...
                <div className="bg-black/60 to-white/5 rounded-lg">
                  <div className="flex flex-row items-center">
                    ...
                    <div className="p-2">
                      ...
                      <p className="text-gray-500 text-md">23 Nov 2022</p>
                    </div>
                  </div>
                  <div className="border-t border-white/5 p-4">
                    <a
                ...
                <div className="bg-black/60 to-white/5 rounded-lg">
                  <div className="flex flex-row items-center">
                    ...
                    <div className="p-2">
                      ...
                      <p className="text-gray-500 text-md">22 Nov 2022</p>
                    </div>
                  </div>
                  <div className="border-t border-white/5 p-4">
                    <a
