...
const SignUp = () => {
  ...
  return (
    <div>
      <>
        <section className=" font-[sans-serif] mb-4">
          <div className="flex flex-col md:flex-row items-center max-w-5xl px-4 py-4 lg:px-12  mx-auto border border-gray-100 rounded-2xl shadow-2xl">
            <div className="w-full md:w-1/2 flex justify-center md:justify-end ">
              ...
              >
                <div className="mx-auto max-w-md p-8">
                  <h1 className="text-3xl lg:text-4xl text-indigo-600 font-bold capitalize font-[sans-serif]">
                    Create Your Account
                  </h1>
                  ...
                  <button className="mt-4 tracking-wide font-semibold bg-indigo-500 text-gray-100 w-full py-4 rounded-lg hover:bg-indigo-700 transition-all duration-300 ease-in-out flex items-center justify-center focus:shadow-outline focus:outline-none">
                    <svg
            ...
            <div className="hidden md:block w-full md:w-1/2 lg:mr-8 font-[sans-serif]">
              <img
